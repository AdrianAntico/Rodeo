# Rodeo is a package for quickly creating high quality visualizations under a common and easy api.
...
#'
#' # Load to warehouse
#' Rodeo::PostGRE_RemoveCreateAppend(
#'   data = data,
#'   Append = TRUE,
